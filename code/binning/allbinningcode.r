...
totalprodbin_shade_byyear_samebins <- lapply(shadedat[2:3], function(z) logbin_setedges(x = z$light_received/z$crownarea, y = z$production, edges = light_per_area_bins_all))
totalprodbin_gap_byyear_samebins <- lapply(gapdat[2:3], function(z) logbin_setedges(x = z$light_received/z$crownarea, y = z$production, edges = light_per_area_bins_all))

densitybin_shade_byyear_samebins <- lapply(shadedat[2:3], function(z) logbin_setedges(x = z$light_received/z$crownarea, y = NULL, edges = light_per_area_bins_all))
densitybin_gap_byyear_samebins <- lapply(gapdat[2:3], function(z) logbin_setedges(x = z$light_received/z$crownarea, y = NULL, edges = light_per_area_bins_all))
