...
source('~/forestlight/stancode/predictedbins.r')
...
fit_info <- get_predbins(dens_model = mod_df$dens_model[task],
...
write.csv(fit_info, file = paste0('~/forestlight/stanoutput/fitinfo/predbin_',task,'.csv'))