...
write.csv(prod_light_bin_all, file = 'C:/Users/Q/google_drive/ForestLight/data/data_forplotting_light_june2018/obs_light_binned.csv', row.names = FALSE)

write.csv(rbind(
  cbind(year = 1990, dat90),
  cbind(year = 1995, dat95)
), 
file = 'C:/Users/Q/google_drive/ForestLight/data/data_forplotting_light_june2018/obs_light_raw.csv', 
row.names = FALSE)
