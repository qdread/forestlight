...
exl <- expression(paste('Light per Crown Area (W cm'^-1, 'm'^-2, ')', sep = ''))
exv <- expression(paste('Light per Crown Volume (W cm'^-1, ')', sep = ''))
exd <- 'Diameter (cm)'

####### by area ######
# Each group
ggplot() +
  geom_point(alpha = 0.05, data = alltree_light_95 %>% filter(!is.na(fg)), aes(x = dbh_corr, y = light_received/crownarea), color = 'forestgreen') +
...
# All together
ggplot() +
  geom_point(alpha = 0.05, data = alltree_light_95, aes(x = dbh_corr, y = light_received/crownarea), color = 'forestgreen') +
...
# All together
ggplot() +
  geom_point(alpha = 0.05, data = alltree_light_95, aes(x = dbh_corr, y = light_received/crownvolume), color = 'forestgreen') +
