...
##################################################
### ADDED 25 FEB 2019: Do the same for raw light.#
##################################################

fp <- '~/forestlight/stanoutput/rawlightfitinfo'
...
fit_ics <- map_dfr(fit_info_list, get_ics)
fit_ics <- cbind(mod_df[rep(1:nrow(mod_df), each=4),], fit_ics)
write.csv(fit_ics, file = '~/forestlight/rawlightpiecewise_ics_by_fg.csv', row.names = FALSE)
...
write.csv(param_cis, file = '~/forestlight/rawlightpiecewise_paramci_by_fg.csv', row.names = FALSE)
...
write.csv(pred_values, file = '~/forestlight/rawlightpiecewise_ci_by_fg.csv', row.names = FALSE)
...
write.csv(fitted_slopes, file = '~/forestlight/rawlightpiecewise_fitted_slopes_by_fg.csv', row.names = FALSE)
...
write.csv(r2s, file = '~/forestlight/rawlightpiecewise_r2_by_fg.csv', row.names = FALSE)