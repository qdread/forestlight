...
write.csv(indivdiamgrowth_param_df, '~/google_drive/ForestLight/data/data_piecewisefits/clean_parameters_individualdiametergrowth.csv', row.names = FALSE)
...
write.csv(r2df, '~/google_drive/ForestLight/data/data_piecewisefits/clean_rsquared_individualdiametergrowth.csv', row.names = FALSE)
...
write.csv(ics, '~/google_drive/ForestLight/data/data_piecewisefits/clean_WAIC_by_functionalgroup_individualdiametergrowth.csv', row.names = FALSE)
