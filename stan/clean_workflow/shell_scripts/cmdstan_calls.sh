...
sbatch --export=scaling=production,guild=fg3,year=1995,model=density3,NS=1000,NW=10000,seed=22313 --time=7-00:00:00 --job-name=d3_3 fitpiecewise.sh
...
sbatch --export=scaling=production,guild=alltree,year=1995,model=density3,NS=1000,NW=5000,seed=22317 --time=7-00:00:00 --job-name=d3_a --array=2 fitpiecewise.sh
